...
- **Mémoire long terme** à 4 niveaux (perso / projet / **équipe** / **organisation**) avec extraction de faits, déduplication, rappel hybride multi-scopes et consolidation hiérarchique — un agent mandaté par X ne lit jamais le perso de Y ; + un **contexte d'entreprise** (markdown d'onboarding) injecté en lecture seule à tous les agents.
